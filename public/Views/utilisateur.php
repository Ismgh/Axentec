<html>
    ...
    <body>  
        <ul id="slide-out" class="sidenav sidenav-fixed"><!--navigation-->
            ...
            <li class="active"><a href="#!"><i class="material-icons">account_circle</i>les utilisateurs</a></li>
        ...
        <div class="container">
            <div class="row row1">
                ...
                <?php
                    /* la boucle sur les utilisateurs*/
                ...
                <div class="col l4 m6 s12"><!--utilisateur-->
                    <div class="card" style="box-shadow : gray 1px 1px 15px;"><!--card-->
                        <div class="card-image waves-effect waves-block waves-light"><!--le titre-->
                            <img src="../src/pics/utilisateur.jpg"><!--image principale-->
                            <span class="card-title" style="font-family: 'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;text-shadow:black 1px 1px 13px;"><?php echo $row["user"];?></span>
                        </div>
                        <div class="card-content" style="overflow-x: auto;">
                        <table class="striped">
                            <tr>
                                <th style="font-size:15px"> nom d'utilisateur</th>
                                <td style="font-size:15px"><?php echo $row["user"];?></td>
                            </tr>
                            <tr>
                                <th style="font-size:15px"> email</th>
                                <td style="font-size:15px"><?php echo $row["email_utilisateur"];?></td>
                            </tr>
                            <tr>
                                <th style="font-size:15px"> mot de pass</th>
                                <td style="font-size:15px"><?php echo $row["password"];?></td>
                            </tr>
                            <tr>
                        ...
                        <div class="card-action"><!--bouton d'inscription-->
                            ...
                            <a href="?supprimer=<?php echo $row["user"];?>" class="btn-floating btn-small waves-effect waves-light red tooltipped " data-position="right"  data-tooltip="supprimer"><i class="material-icons">delete</i></a>
                        </div>
                    </div><!--/card-->
        ...
        <div id="modal" class="modal modal-fixed-footer"><!-- Modal Structure -->
            ...
            <form id="modal_form" class="col s12 " method="post" action="">
                ...
                <input placeholder="" id="user" name="user" type="text" class="validate" required hidden>
                <div class="input-field col s12">
                    <i class="material-icons prefix">mail</i>
                    <input placeholder="" id="email_utilisateur" name="email_utilisateur" type="text" class="validate" required>
                    <label for="email_utilisateur">l'email</label>
                </div>
                <div class="input-field col s12">
                    <i class="material-icons prefix">lock</i>
                    <input placeholder="" id="password" name="password" type="text" class="validate" required>
        ...
        <script>
            ...
            function ajouter() 
            {
                ...
                document.getElementById("email_utilisateur").setAttribute("value","");
            ...
            {//obtenire les valeur de la formation selectionée
                ...
                document.getElementById("user").setAttribute("value",form.getElementsByTagName("span")[0].innerHTML);
                document.getElementById("email_utilisateur").setAttribute("value",form.getElementsByTagName("td")[1].innerHTML);
                document.getElementById("password").setAttribute("value",form.getElementsByTagName("td")[2].innerHTML);
                document.getElementById("id_type").setAttribute("value",form.getElementsByTagName("td")[3].innerHTML);
